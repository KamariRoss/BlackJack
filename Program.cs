            ...
            while (flag)
            {
                ...
                while (pass)
                {
                    ...
                    if (playerTotal >= 21 || playerChoice == "stand")
                    {
                        ...
                        else if (dealerTotal != 21 && playerTotal != 21 && dealerTotal > playerTotal || playerTotal > 21)
                        {
                            Console.WriteLine($"You lose! The dealer's total was {dealerTotal} and yours was {playerTotal} ");
                        }
                        else if (dealerTotal != 21 && playerTotal != 21 && dealerTotal < playerTotal || dealerTotal > 21)
                        {
